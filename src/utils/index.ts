...
import validator, { VALIDATOR, EMAILVALIDATION, EMAILVALIDATIONWITHMESSAGE, PHONENUMBERVALIDATION, NAMEVALIDATION, PASSWORDVALIDATION, PASSWORDVALIDATIONWITHMESSAGE, URLVALIDATION, LENGTHVALIDATION } from "./VALIDATOR";
